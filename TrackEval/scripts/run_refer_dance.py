...
Run example:
run_refer_kitti.py --USE_PARALLEL False --METRICS Hota --TRACKERS_TO_EVAL CIWT
...
def evaluate_refer_dance(tracker_path, split, data_path, tracker_sub_folder, output_sub_folder, text):
    """
    ...
    default_dataset_config = trackeval.datasets.ReferDance2DBox.get_default_dataset_config()
    ...
    dataset_config['GT_FOLDER'] = os.path.join(data_path, "REFER-DANCE", "DanceTrack", "training", "processed_refer_data")
    ...
    dataset_list = [trackeval.datasets.ReferDance2DBox(dataset_config)]
    metrics_list = []
