...
def evaluate_refer_kitti(tracker_path, split, data_path, tracker_sub_folder, output_sub_folder):
    ...
    default_dataset_config = trackeval.datasets.ReferKitti2DBox.get_default_dataset_config()
    ...
    dataset_list = [trackeval.datasets.ReferKitti2DBox(dataset_config)]
    metrics_list = []
