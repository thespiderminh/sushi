...
def get_arguments(args=None):
    ...
    # SPLITS
    parser.add_argument('--train_splits', type=str, nargs='*', help='Training split', default="kitti-train-all")
    parser.add_argument('--val_splits', type=str, nargs='*', help='Validation split', default="kitti-train-all")
    parser.add_argument('--test_splits', type=str, nargs='*', help='Test split', default=[None])
    parser.add_argument('--cval_seqs', help='All range that crossvalidation covers (e.g all train seqs)', type=str, default='kitti-train-all')
    ...
    # GRAPH PARAMETERS
    parser.add_argument('--top_k_nns', help='Similarity of nodes to connect in a graph', type=int, default=20)
