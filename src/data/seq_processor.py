...
_SEQ_TYPE_DETS_DF_LOADER = {'MOT': get_mot_det_df_from_det, 'MOT_GT': get_mot_det_df_from_gt, 'MOT_DANCETRACK': get_dancetrack_det_df_from_det, 'MOT_BDD': get_bdd_det_df_from_det, 'KITTI': get_kitti_det_df}
_SEQ_TYPE_GT_DF_LOADER = {'MOT': get_mot_gt, 'MOT_GT': get_mot_gt, 'MOT_DANCETRACK': get_dancetrack_gt, 'MOT_BDD': get_bdd_gt, 'KITTI': None}

# Are boxes allowed to be outside?
_ENSURE_BOX_IN_FRAME = {'MOT': False, 'MOT_GT': False, 'MOT_DANCETRACK': False, 'MOT_BDD': False, 'KITTI': True}  # MOT17 boxes are inside the frame for both det and gt
